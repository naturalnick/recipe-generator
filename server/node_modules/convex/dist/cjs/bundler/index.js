...
async function entryPoints(ctx, dir) {
  ...
  for (const { isDir, path: fpath, depth } of walkDir(ctx.fs, dir)) {
    ...
    if (relPath.startsWith("_generated" + import_path.default.sep)) {
      ...
      (0, import_context.logVerbose)(ctx, import_chalk.default.yellow(`Skipping ${fpath} txt file`));
    } else if (base.endsWith(".md")) {
      (0, import_context.logVerbose)(ctx, import_chalk.default.yellow(`Skipping ${fpath} markdown file`));
    } else {
